  ...
  return (
    <div className="min-h-screen bg-white pt-28 pb-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 mb-4"><div className="divider-red" /><span className="section-label">DSGVO</span></div>
        <h1 className="text-4xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: '-0.02em' }}>Datenschutzerklärung</h1>
        <p className="text-gray-400 mb-12">Stand: Mai 2026</p>

        <div className="space-y-10 text-gray-600 leading-relaxed text-sm">
          
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>1. Datenschutz auf einen Blick</h2>
            <div className="card-light p-6 space-y-4">
              <div>
                <h3 className="text-gray-900 font-semibold mb-2">Allgemeine Hinweise</h3>
                <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.</p>
              </div>
              <div>
                <h3 className="text-gray-900 font-semibold mb-2">Datenerfassung auf dieser Website</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>2. Verantwortliche Stelle</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>3. Erhebung und Speicherung personenbezogener Daten</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-gray-900 font-semibold mb-2">Beim Besuch der Website</h3>
              ...
              <div>
                <h3 className="text-gray-900 font-semibold mb-2">Kontaktformular</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>4. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>5. Ihre Rechte</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>6. Datensicherheit</h2>
            <div className="card-light p-6">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>7. Kontakt bei Datenschutzfragen</h2>
            <div className="card-light p-6">
              <p>Bei Fragen zum Datenschutz wenden Sie sich bitte an:</p>
              <p className="mt-2 text-gray-900 font-semibold">DN AirTecH GmbH</p>
              <p>E-Mail: <a href="mailto:info@dn-airtechgmbh.de" className="text-red-600 hover:underline">info@dn-airtechgmbh.de</a></p>
              <p>Telefon: <a href="tel:+4969330887540" className="text-red-600 hover:underline">+49 69 3308 8754</a></p>
            </div>
          </section>
