  ...
  return (
    <div className="min-h-screen bg-background pt-28 pb-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 mb-4"><div className="w-8 h-px bg-cyan-400" /><span className="section-label">Rechtliches</span></div>
        <h1 className="text-4xl font-bold text-white mb-12" style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: '-0.02em' }}>Impressum</h1>

        <div className="space-y-10 text-slate-400 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Angaben gemäß § 5 TMG</h2>
            <div className="glass-card neon-border p-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Kontakt</h2>
            <div className="glass-card neon-border p-6 space-y-2">
              <p>Telefon: <a href="tel:+4969330887540" className="text-cyan-400 hover:underline">+49 69 3308 8754</a></p>
              <p>Telefon: <a href="tel:+4969663895240" className="text-cyan-400 hover:underline">+49 69 6638 9524</a></p>
              <p>E-Mail: <a href="mailto:info@dn-airtechgmbh.de" className="text-cyan-400 hover:underline">info@dn-airtechgmbh.de</a></p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Handelsregister</h2>
            <div className="glass-card neon-border p-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Umsatzsteuer-ID</h2>
            <div className="glass-card neon-border p-6">
              <p>Umsatzsteuer-Identifikationsnummer gemäß § 27a Umsatzsteuergesetz:</p>
              <p className="text-white font-semibold mt-1">DE363307976</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
            <div className="glass-card neon-border p-6">
              <p>DN AirTecH GmbH</p>
              <p>Heinrich-Krumm-Straße 20</p>
              <p>63073 Offenbach am Main</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Haftungsausschluss</h2>
